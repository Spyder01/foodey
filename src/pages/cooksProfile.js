...
import {Avatar, Card, CardContent, Divider, Grid, List, ListItem, ListItemText, InputLabel, Select, MenuItem, FormControl, Button} from '@material-ui/core';
...
const Profile = ()=>{
    ...
    const {Profile_Image, Name, State, Year_Of_Experience, Region, Ratings, Speciality} = cook;
    ...
    return (
        ...
        <div className="cookProfile">
            ...
            <Card className={styles.root}>
                ...
                <CardContent>
                    <h4 className='cook-profile-name'>
                        {Name}
                    </h4>
                    <Divider/>
                    ...
                    <List>
                     <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} sm={6} md={6} lg={6}>
                                <ListItem>
                                    <ListItemText>Experience: {Year_Of_Experience} years</ListItemText>
                                </ListItem>
                            </Grid>
                            <Grid item xs={12} sm={6} md={6} lg={6}>
                                <ListItem>
                    ...
                    <FormControl variant="outlined" className={styles.formControl}>
                        <Select labelId="subscription" value={subscription} onChange={handleChange} >
                    ...
                    <Button className={styles.btn} onClick={()=>!isLoggedIn?History.push('/login'):History.push('/invoice')} variant="contained">Proceed to Checkout</Button>
                    </div>   
                    </form>         
                </CardContent>
